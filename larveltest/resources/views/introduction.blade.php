			...
			<div id="main">
					...
					<!-- Boxes -->
						<div class="thumbnails">
							...
							->get();
							$comment_s = DB::table('Video')
							->leftJoin('comments', 'Video.video_id', '=', 'comments.video_id')
							->where('video_name', '=', $_GET['video_name'])
							->get();
							...
							foreach ($comment_s as $comment_s)
							{
								echo $comment_s->comments_name.'<br>';
							}*/
							foreach ($Video as $Video)
							{
								echo '<div class="image fit">
									<img src="'.$Video->videopicture.'" alt="" /></a>
									</div>';
								echo "<p>影片名稱：" .$Video->video_name."<br/>主演：" .$Video->actor_name."<br/>簡介：" .$Video->plot_name."<br/>類型：" .$Video->type_name."<br/>導演：" .$Video->director_name."<br/>編劇：" .$Video->screenwriter_name."<br/>劇別：" .$Video->source_name."<br/>區域：" .$Video->area_name."<br/>影片來源：" .$Video->film_source."<br/>評分：" .$Video->score."</p>";
								echo '<a href = "'.$Video->videourl.'" data-poptrox="ignore">影片來源（愛奇藝）</a>';
							}
							foreach ($comment_s as $comment_s)
							{
								echo "<p>評論：" .$comment_s->comments_name."</p>";
							}
							?>
